...
public class Task4 {
    public static void main(String[] args) {
        MusicBand tokiyoHotel = new MusicBand("Tokiyo Hotel", 2000,"dsfsdfsd", "asfsdf");
        MusicBand nirvana = new MusicBand("Nirvana", 1970, "sfsfsdfsd", "dasfsdfsdfsdfsd");
        ...
        nirvana.showMembers();
        transferMembers(nirvana,tokiyoHotel);
        tokiyoHotel.showMembers();
        nirvana.showMembers();
